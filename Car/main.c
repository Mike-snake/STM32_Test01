...
void Motor_SetSpeed(uint16_t speed) {
    __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_1, speed);  // PWM 설정
}
...
void Motor_Start(uint8_t direction, uint16_t speed) {
...
//      Motor_Start(1, 599);  // 정방향, 속도 500
//      HAL_Delay(2000);
//      Motor_Start(1, 999);  // 역방향, 속도 500
//      HAL_Delay(2000);
    /* USER CODE END WHILE */
